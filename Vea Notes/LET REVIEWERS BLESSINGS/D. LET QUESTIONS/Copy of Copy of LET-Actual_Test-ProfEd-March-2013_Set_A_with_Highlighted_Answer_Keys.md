...
SET B – MULTIPLE CHOICE
	•	As a parent and at the same time a teacher, which of the following will you to do to show your cooperation to a PTA project in your school to be financed with the proceeds of the sales of the school canteen where food prices are a little bit higher?
	...
	•	Periodic checks on student seatwork with a smile and pat on the should effectively reinforce good study habit is an example of ____.
	•	Discrimination reinforcement	C.  Continuous reinforcement
	•	Variable-ratio schedule		D. Fixed interval and variable interval schedule

	•	A person strives to work at a given task because of a need.  Which of the following situations can make a person strive to meet his needs? (needs of the learners)
	...
	•	Ask pupils to submit test questions or reactions from which you can select topics.

	•	The singing of the National Anthem in schools in an offshoot of the philosophy of ____.
	•	Nationalism				C.  Naturalism
	•	Pragmatism				D. Socialism

	•	The environment in order to facilitates, learning must be interactive.  Which of the following best typifies this kind of environment?
	...
	•	The child summarizes the section on fossils in his science textbook.
	•	The child copies a list of fact concerning fossils on the blackboard.

	•	Social development means that acquisition of the ability to behave in accordance with ____.
	•	Social expectation				C. Social insight
	•	Stereotyped behavior			D. Universal norms
(in every stage of development there is social expectation)
	...
	•	He interprets events from a limited views
	•	He views events apart from himself and other people
	•	He views the world and himself through the eyes of other people

	•	Who introduced the technique of using the drawing of a man as a measure of intelligence?
	•	Aristotle		B. Herbert		C. Goodenough		D. Benet

	•	Which Republic Act provides government assistance to students and teachers in private education?
	•	RA 7784		B. RA 6728		C. RA 7836			D. RA 6675

	•	The authoritarian setting in the Filipino home is reinforced by a classroom teacher who:
	•	Encourage pupils to ask questions		C. Is open to suggestions
	•	Prescribes what pupils should do		D. Ask open ended questions
	...
	•	Essentialist		B. Perennialist		C. Progressivist		D. Reconstructionist
(curriculum-centered)
	...
	•	To make Filipino the sole medium of instruction(no-against bilingual; multilingual policy)
	•	To make Filipino the national language & medium of instruction & communication
	•	The tendency to emphasize so much on school beautification to the detriment of pupils performance illustrates the:
	•	Filipino’s lack of seriousness			C. Filipino’s sense of humor
	•	Filipino’s lack of reflection			D. Filipino’s love for “porma”
	•	Which is NOT a characteristic of democratic discipline?
	•	Child has opportunity to express his/her opinion
	•	Child given punishment is related to the misdeed
	•	Child understands the meaning of rules
	•	Child obeys blindly

	•	Who among the following stressed the processes of experience and problem solving?
	•	Dewey		B. Aristotle		C. Hegel		D. Plato

	•	Which of the following reasons for measuring student achievement is NOT valid?
	...
	•	To motivate students to learn & master the materials they think will be covered by the achievement test.
	...
	•	Often anxious, fearful or frustrated about quality work

	•	When a school decides to work on a thematic curriculum which should be out of the picture?
	•	Peer collaboration	         B. Integration	    C. Team teaching		D. Competition

	•	Teacher wants to teach his pupils the technique on reading for information. Which technique should be use?
	•	Text structure	B. Prior knowledge	C. Story map		D. SQ3R

	•	In instructional planning, which among these three: unit plan, course plan, lesson plan is (are) most specific? ____plans
	•	Course and lesson		B. Course	C. Lesson	D. Unit

	•	The use of drills in the classroom is rooted on Thorndike’s law of:
	•	Readiness		B. Exercise		C. Effect		D. Belongingness
	...
	•	Which of the following measures should a teacher do to a principal whom she would like to file a case of sexual harassment w/o violating the relationship of the teacher to her superiors?
	•	Present the case before competent authority & prepare to prove the charge
	...
	•	The telephone company is to blame for this (not a solution)
	•	The government restriction have no teeth(not a solution)
	•	Parents allow this to make their children modern(inconsistent to the situation)
	•	Parents, school and students should discuss this openly

	•	Cooperatives are encouraged in as many groups as possible. What agency controls the different cooperatives?
	•	Security and Exchange Commission		C. Commission on Audit
	•	Department of Local Government		D. Bureau of Cooperative(Cooperative Development Authority)
	...
	•	TV ads show drinking is a source of fellowship (the only choice that includes media & society)
	•	High taxes on liquor will be a deterrent to eventual drug use
	...
	•	School book stores				C. Schools uniform purchases
	•	School canteen				D. Class stores

	•	A student collapsed in her social class. It was found out that he did not eat her lunch. What principle is shown in the situation?
	•	Psychological need		B. Physiological need	C. Somatotonic		D. Safety need
	...
	•	CPU		B. Software		C. Video screen		D. Keyboard
	...
	•	Consensus decision		B. Composite report	C. Jury trial	D. Agenda

	•	In the formulation of classroom, which of the following should a teacher refrain from doing?
	•	State classroom regulation as clearly as possible
	•	Enlist student aid in the formulation of classroom regulation
	•	Enforce classroom regulations consistently and fairly
	•	Teacher and the class should make as many regulations as possible (3 -5 ONLY Harry Wong)
	...
	•	Prenatal period				C. Early childhood
	•	Early adolescence				D. Pubescence

	•	How does fear affect the voluntariness of an act?
	•	Makes the act involuntary			C. Increase voluntariness
	•	No effect at all				D. Lessens but not destroy voluntariness (fear-
                                                                       modifier of human act)

	•	A group of people asserts that their culture is superior to another. This exemplifies:
	•	Cultural gap					C. Norm conflict
	•	Cultural conflict				D. Ethnocentrism
                                                                      (equivalent to superiority complex)

	•	A test consists of a graph showing the relationship between age and population. Following it is a series of true-false items based on the graph. Which type of test does this illustrate?
	•	Laboratory exercise				C. Performance
	•	Problem solving				D. Interpretative
	...
	•	Mainframe computer				C. Microcomputer
	•	Minicomputer				D. LPC

	•	A teacher notices glaring wrong pronunciation of vowel sounds among her students necessitating more practice. Which of the following activities would be at most help?
	•	Dictionary use				C. Assignments
	•	Review					D. Drill

	•	Which storage device is significantly more efficient in holding information
	•	Hard disk		B. Software		C. Floppy disk		D. Audio cassette
	...
	•	Anticipation	B. Ambivalence		C. Pakikisama		D. Lack of discipline

	•	“No pain, no gain”. This means that:
	•	Only those willing to carry the crosses that like impose can share the joy of life
	•	One should be a penitent every good Friday by carrying his cross(not logical)
	•	The more suffering in this life, the more one is assured of heaven (fanatism)
	•	One should look for suffering to save himself/herself (not logical)
	...
	•	Value inculcation				C. Value clarification (investigation)
	•	Analysis					D. Moral development

	•	Which interactive teaching should be AVOIDED?
	•	Using “put down” strategy			C. Asking more divergent questions
	•	Using multiple response strategy		D. Asking more evaluative questions
	...
	•	In mastery learning the definition of an acceptable standard of performance is called
	•	Condition		B. Behavior		C. SMART		D. Criterion measure
	...
	•	Your teacher is of the opinion that the world and everything in it are changing and so teaches you the skill to cope with the changes. Which in his governing philosophy?
	•	Experimentalism (progressivism)  B. Existentialism		C. Realism	D. Idealism

	•	For brainstorming to be effective which one should be out?
	•	Making use of the other’s ideas shared		C. Non-threatening atmosphere
	•	Teacher’s judge mental attitude			D. Openness to idea

	•	Which statement on spaced and massed learning is CORRECT?
	•	Massed learning is better than spaced learning
	•	Spaced learning is better than massed learning (teach less, teach well)
	•	Massed learning is as effective as spaced learning
	•	Both massed learning & spaced learning are not effective

	•	A teacher is a facilitator of learning and of the development of the youth. Which practice NOT keeping with his role as facilitator?
	...
	•	Telling everyone that he went to teaching for there was no other choice them
	...
	•	Manipulate		B. Integrate		C. Delineate		D. Comprehend
	...
	•	Provides information to student’s about their competence and the value of their accomplishments
	...
	•	The use of the process approach gives the students the opportunity to:
	•	Learn to their own				C. Make use of laboratory apparatuses
	•	Apply the scientific method			D. Learn how to learn

	•	A comprehension skill of higher level which may be inferred or implied from reading is:
	•	Picking out the main idea			C. Following direction
	•	Nothing specific details			D. Drawing conclusion (synthesis)

	•	In the Preamble of the Code of Ethics of Processional Teachers, which is not mention about teachers?
	•	Dully licensed professionals			C. LET passers
	•	Possess dignity and reputation		D. With high moral values
	...
	•	A teacher discovers that a product of certain bottling company brings about damage to teeth. Much as he wants to share the products of his research, he could not because of harassment from all sides. Which teacher’s right is violated?
	•	Right to property
	...
	•	Moral and feeling being			C. Thinking, feeling and acting being
	•	Material and an acting being			D. Spiritual and material being
	...
	•	It needs only a few instruction materials
	...
	•	Skim reading		B. Scanning		C. Oral reading		D. Silent reading
	...
	•	Composite report	     B. Symposium		C. Agenda	D. Consensus decision making

	•	Which term applies to the search for related literature by computer access of data bases on discs kept in libraries?
	•	On-line research				C. Compact discs computer research
	•	Manual research				D. Computer research

	•	Which best indicates the effectiveness classroom activities?
	...
	•	Acquaint students w/ the historical development of the Philippine Constitution
	•	Prepare students for law-making
	•	Make constitutional experts of the students

	•	Some students who are high in the scholastic aptitude tests have failed in collage. Some who are below the standards set for admission, but who, for various reasons, were admitted, attained satisfactory standings. This provide that
	•	Human beings are certainly predictable
	•	Admission tests are not accurate, hence should not be used
	•	Aptitude tests do not measure all factors import for success
	•	Aptitude tests can be perfectly relied on

	•	If the teacher’s pattern in questioning consists of calling on a student then asking the question
	...
	•	Yes, it can save her and the child from disgrace when he grows up
	...
	•	By placing limits beyond which the learner cannot develop (maturity and readiness)
	...
	•	Taoism		B. Shintoism		C. Confucianism  D. Zen Buddhism
	...
	•	Detain him after office hours for him to do what he has been ordered to do
	•	Insist on compliance to the same degree required of pupils
	•	Avoid giving him orders or if you do he objects take back the order

	•	Which term refers to the collection of student’s products and accomplishment for a period of evaluation purposes?
	•	Portfolio		B. Observation report	C. Anecdotal record		D. Diary

	•	For comparing and contrasting, which graphic organizer is most appropriate?
	•	Cycle		B. Web			C. Story map		D. Venn diagram

	•	Laging UMUUKILKIL saisipanangnasirangpangakonganak.
	•	Sumasapi		B. Gumugulo		C. Bumubuhay		D. Sumasapi

	•	Huwagkangmaniniwalasabulaklakngkanyangmatamisnadila.
	•	Ito’ypanunukso				C. Ito’ypagbibiro
	•	Ito’ypambobola				D. Ito’ypagsisinungaling

	•	If a resilient child with superior intelligence is reared in a poor environment the probable outcome would be
	•	No change in IQ because environment deprivation has nothing to do w/ intelligence
	•	Slight change in IQ although he can overcome frustration and obstacles
	•	Mental retardation in IQ because he is culturally deprived

	•	Which of the following is usually considered the most important factor in a child’s observable classroom behavior?
	•	Intelligence		B. Heredity		C. Self-concept		D. Cultural background

	•	Section 5, article XIV, of the Constitution states that academic freedom shall be enjoyed in
	•	Public assemblies				C. All levels of learning
	•	State colleges and universities	D. All institution of higher learning
	...
	•	Freud expounded that there is a period when young boys experience rivalry with their father for their mother’s affection. This is
	•	Oedipus complex					C. Achilles syndrome
	•	Electra complex					D. Cassandra syndrome
	...
	•	Counselors	B. Role models	      C. Disciplinarians	   D. Facilitators of learning
	...
	•	National development requirements & reflects search based direction

	•	   The child cannot distinguish abstracts during the sensory motor period of development. Which of these techniques should a teacher apply to accommodate learning?
	•	Make use of individualize instruction
	•	Explain the lesson very well
	•	Utilize concrete objects to clarify concept
	•	Provide variety of educational toys (sensorimotor-0 to 2)

	•	Which of these systems of learning includes ways and methods which are used in preserving and building certain traditions within cultural communities?
	•	Non-formal learning				C. Cultural learning
	•	Multi-level learning				D. Indigenous learning

	•	Which of the following statements is TRUE in the use of experiments and demonstrations in teaching science
	•	It is valuable if used in the context of a lesson that relates observation to other information
	•	It should be encouraged in elementary school since the concepts they encompass are difficult for your children
	•	It is as valuable as teaching by lecturing
	•	It is less valuable than teaching through inquiry and discussion

	•	Identical twins are more alike than fraternal twins. Which of the following statements/principles supported by this?
	...
	•	Intelligence is determined partly by pre-natal nutrition (b-c-d about intelligence)
	...
	•	As soon as the students have established		C. During his homeroom days
	•	Daily at the start of the session			D. On the very first day of school

	•	In large classes where little of the work can be individualized the most effective and practical ways to individualize instruction to
	•	Devise group activities w/c afford every pupils an opportunity to work at his own
	...
	•	Which of these is the MOST important principle that a teacher should follow in initiating a program of positive reinforcement?
	...
	•	Discovery approach				C. Integrative approach
	•	Conceptual technique			D. Project Method

	•	The best way the teacher can be sure of the appropriateness of an instructional material is to
	•	Consider its technical quality			C. Consider its availability
	•	Try it out before using it in class		D. Consider its cost

	•	Task analysis involves the breaking down of a learning task into subtasks or sub-skills. Given a task to retell a story, which of the following skills is NOT needed?
	•	To disseminate information			C. To identify topic sentences
	•	To outline a selection			D. To arranged events in sequence

	•	You are assigned to teach students with varied abilities. You want to teach a more homogeneous grouping. Which type of grouping will tend to benefit your students?
	•	Mixed ability grouping			C. With-in class ability grouping
	•	Low ability grouping				D. High ability grouping

	•	Which of the following examples illustrate the use of questions to focus pupil attention on the key points of the lesson?
	...
	•	Rules are not defined & procedures to sustain order is not into place
	...
	•	The educational implementation of research findings relative to the ability of dull learners and bright learners to organize and generalize is for the teacher
	...
	•	Prepare a seat plan
	•	Train the class in the distribution of materials

	•	A student was diagnosed to have a high IQ but is failing in his academic subject. What should the teacher do to help him?
	•	Talk to his parents				C. Talk the student & find out his problem
	•	Examine his study habits			D. Refer him to the guidance counselor

	•	When do test, inventories and career information become effective for counseling service?
	...
	•	The psychological test result are still valid and reliable.
	•	When the records are updated.
	•	When the records are kept for ready reference.

	•	Which of the following is a major advantage in using arithmetic mean?
	•	It is more commonly used than other measures
	•	It discriminates between the lowest and the highest
	•	It is simple to computer
	•	It is more than stable than the median

	•	In preparing a multiple choice test how many options would be ideal?
	•	Five			B. Three			C. Any			D. Four
	...
	•	By giving him room responsibility		C. By giving him special help
	•	By assigning peers or Buddies to him	D. By discovering his new interest

	•	Who expounded on the need to study the child carefully for individualized instruction?
	•	Da Feltre		B. Erasmus		C. Boccacio		D. Ascham
	...
	•	Offer to return the used on the monthly installment she paid

	•	Which of the following will you recommended to a senior high school scholar who is impregnated by a fellow student?
	•	Tell her parents about her condition		C. Direct her to an abortion clinic
	•	Stop schooling all after she gives birth	D. Force her boyfriend to marry her
	...
	•	Minimize the unemployment problem		C. Protect the rights of the citizen
	•	Procedure globally competitive graduates	D. Ensure the teaching of Filipino

	•	Teachers should bear in mind that the period of greatest mental development is from:
	•	9 t0 12 years	B. 12 to 15 years	C. 6 to 9 years		D. 3 to 6 years
	...
	•	A teacher paid on an hour basis, entertain her students w/ stories till the end of the period
	...
	•	Call the parents for a dialogue		C. Reprimand him always
	•	Report the case to the principal		D. Talk to him seriously

	•	What should a teacher do before constructing items for a particular test?
	•	Prepare the table of specifications		C. Determine the length of time for answering it
	•	Review the previous lessons			D. Announce to students the scope of the test
	...
	•	Association		B. Definition		C. Difference		D. Cause

	•	Of the following types of test which is the most subjective in scoring?
	•	Matching type	B. Simple call		C. Multiple choice	D. Essay

	•	In which of these research methods can the researcher control certain variable?
	•	Experimental		B. Ex post facto		c. Descriptive		D. Historical
	...
	•	Mental ability		B. Personally		C. Attitude		D. Aptitude

	•	Measuring the work done by a gravitational force is a learning task. At what level of cognitions is it?
	•	Application		B. Knowledge		C. Evaluation		D. Comprehension

	•	Setting up criteria for scoring essay tests is meant to increase their ____.
	•	Objectivity		B. Reliability		C. Validity		D. Usability

	•	Which of the following will you do to an examinee you caught cheating and who offered you a certain sum of money to keep quiet.
	...
	•	Ignore him but let him feel that you saw him (deal with him after the test)
	...
	•	Censor all their only daughter’s suitors
	...
	•	The theory of identical elements in learning holds that transfer is facilitated when the ____.
	•	Teacher uses different teaching devices
	•	Learner has a mastery of specific responses
	•	Development task is easily identifies
	•	Experience is similar to the application situation

	•	If this is not met the adolescent tends to be critical and always tries to find fault. This is the need.
	•	For recognition	B. For adventure	C. To belong		D. For material security

	•	The way a child talks, walks of manifest, gestures may have been learned from models he had been exposed. This explains ____.(Social L. Theory-learning by observation)
	•	Affective		B. Insight		C. Social		D. Cognitive

	•	Audio-visual aids are in classroom teaching to ____?
	•	Help make learning more permanent		C. Help clarify important concept
	•	All of these					D. Arouse & sustain student’s interest

	•	Which of the following is the MOST important purpose for using achievement test? To measure the ____.
	•	Quality and quantity of previous learning		C. Educational & vocational aptitude
	•	Quality & quantity of previous teaching		D. Capacity for failure learning

	•	Which of the different types of test covers a wide variety of objectives?
	•	True-false		B. Multiple choice		C. Matching		D. Essay

	•	In a multiple choice test, keeping the options brief indicates ____.
	•	Inclusion in the item irrelevant clues such as the use in the correct answer
	•	Non-inclusion of opinion that mean the same
	•	Plausibility & attractiveness of the item
	...
	•	Options should be almost the same length
