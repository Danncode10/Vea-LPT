...
1. Doctor Faustus. Christopher Marlowe (Father of English Tragedy) powerfully exemplifies the sum total of the intellectual aspirations of the Renaissance through his play Dr. Faustus. In the play, Faustus sells his soul to the devil in exchange of power and knowledge. 
The Faerie Queene. Edmund Spenser composed this elaborate allegory in honor of the Queen of Fairyland (Queen Elizabeth I). 
Each verse in the Spenserian stanza contains nine lines: eight lines of  HYPERLINK "http://en.wikipedia.org/wiki/Iambic_pentameter" \o "Iambic pentameter" iambic pentameter, with five feet, followed by a single line of iambic  HYPERLINK "http://en.wikipedia.org/wiki/Hexameter" \o "Hexameter" hexameter, an " HYPERLINK "http://en.wikipedia.org/wiki/Alexandrine" \o "Alexandrine" alexandrine," with six. The rhyme scheme of these lines is ababbcbc-cdcdee.
...
The major works of Beat writing are Allen Ginsberg's  HYPERLINK "http://en.wikipedia.org/wiki/Howl" \o "Howl" Howl, William S. Burroughs's Naked Lunch and Jack Kerouac's On the Road. 
...
English and American Literatures |  PAGE   \* MERGEFORMAT 13
